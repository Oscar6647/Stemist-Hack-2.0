const CLIENT_ID = '25078404912-0f27h541nemdtvbvkn8csuqnsbku1b5a.apps.googleusercontent.com'; // Reemplaza con tu ID de cliente
const API_KEY = 'AIzaSyAvK-_venbKyg1hMvY8myxfM-KDhlBstzo'; // Reemplaza con tu clave API
...
function createEvent() {
    ...
    const event = {
      ...
      start: {
        ...
        timeZone: 'YOUR_TIME_ZONE', // Reemplaza con tu zona horaria
      },
      end: {
