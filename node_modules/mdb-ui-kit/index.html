      ...
      <div class="mask" style="
        ...
        <div class="container d-flex align-items-center justify-content-center text-center h-100">
          <div class="text-white">
            ...
            <h5 class="mb-4">We make learning easy for you</h5>
            <a class="btn btn-outline-light btn-lg m-2" href="" role="button" rel="nofollow" target="_blank">Get
              Started</a>
            <a class="btn btn-outline-light btn-lg m-2" href="" target="_blank" role="button">Free Resources</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
          <div class="col">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">One Feature</h5>
                <p class="card-text">
                  One cool description of the feature.
                </p>
              </div>
            </div>
          </div>
      ...
      <section">
        <div id="intro" class="p-5 text-center bg-light shadow-5 rounded-5 mb-5">
          <h1 class="mb-3 h2">Learn how to make interactive content</h1>
          <p class="mb-3">Free support with your learning material</p>
          <a class="btn btn-primary m-2" href="" role="button" rel="nofollow" target="_blank">Start tutorial</a>
          <a class="btn btn-primary m-2" href="" target="_blank" role="button">Try it now</a>
        </div>
